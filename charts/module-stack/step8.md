Now we'll change the `Chart` component theme color...
...
<img src="module-stack/assets/theme.png" alt="Chart with theme color" style="box-shadow: rgba(3, 3, 3, 0.2) 0px 1.25px 2.5px 0px;" />
