...
In this course, we're going to build a PatternFly donut utilization chart together - starting with a simple chart, adding thresholds, tooltips, a legend, and concluding by changing the theme color.
...
<img src="module-donut-utilization/assets/final.png" alt="Completed chart component" style="box-shadow: rgba(3, 3, 3, 0.2) 0px 1.25px 2.5px 0px;" />
